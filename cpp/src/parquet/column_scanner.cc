...
// int64_t ScanAllValuesBitpos(int32_t batch_size, int16_t* def_levels, int16_t*
// rep_levels,
//                             uint8_t* values, int64_t* values_buffered,
